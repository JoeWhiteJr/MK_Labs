...
function buildSystemPrompt(chunks) {
  if (chunks.length === 0) {
    return `You are a helpful research assistant for Michael Kairos Labs. You help users understand and analyze research documents.
...
No relevant documents were found for this query. Let the user know you couldn't find matching content in the indexed documents, but still try to help if you can based on the question alone.`;
  ...
  return `You are a helpful research assistant for Michael Kairos Labs. You help users understand and analyze research documents uploaded to their projects.
