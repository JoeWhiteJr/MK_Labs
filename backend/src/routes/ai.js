...
router.post('/chat', authenticate, [
  ...
  try {
    ...
    const systemPrompt = context
      ? `You are a helpful AI assistant for Michael Kairos Labs, a research and analytics consulting platform. Context: ${context}`
      : 'You are a helpful AI assistant for Michael Kairos Labs, a research and analytics consulting platform. Help users with their questions about projects, research, and team collaboration.';
