    ...
    >
      {phase === 'preview' ? (
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0 space-y-5">
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              {isMember ? null : isPending ? (
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-organic text-sm font-medium bg-amber-100 text-amber-700">
                  Request Pending
                </span>
              ) : (
          ...
          {members.length > 0 && (
            <div className="w-full md:w-64 shrink-0 md:border-l md:border-gray-200 md: md:pl-6">
        ...
        <div className="text-center space-y-4 py-4">
          ...
          {/* Lead info */}
          {project.lead_name && (
            <div className="inline-flex items-center gap-3 rounded-lg border border-gray-200 bg-gray-50 px-4 py-3">
              <div className="w-8 h-8 rounded-full bg-primary-100 flex items-center justify-center">
                <User size={14} className="text-primary-600" />
              </div>
              <div className="text-left">
                <p className="text-sm font-medium text-text-primary">{project.lead_name}</p>
                {project.lead_email && (
                  <a
                    href={`mailto:${project.lead_email}`}
