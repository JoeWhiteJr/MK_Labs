    ...
    <div className="group bg-white rounded-lg border border-gray-200 p-4 hover:border-primary-300 hover:shadow-sm transition-all">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        {hasTranscript ? (
          ...
          <button
            onClick={() => onView?.(meeting)}
            className="inline-flex items-center gap-1 px-2 py-1 rounded text-xs bg-gray-100 text-gray-500 cursor-pointer hover:bg-gray-200 hover:text-gray-700 transition-colors"
          >
            <FileText size={12} />
            No transcript
          </button>
      ...
      <button
        onClick={() => onView?.(meeting)}
        className="mt-3 w-full flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium text-text-secondary border border-gray-200 rounded-lg hover:border-primary-300 hover:text-primary-600 transition-colors"
      >
        <FileText size={14} />
        Open Meeting Notes
      </button>
