      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-gray-200">
          ...
          <div className="flex items-center gap-2">
            ...
            <button onClick={onClose} className="p-2 text-gray-400 hover:bg-gray-100 rounded-lg transition-colors" aria-label="Close">
              <X size={18} />
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-300 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300"
              />
            </div>
            <div>
            ...
            {showNewCategory && (
              <div className="mt-3 p-3 bg-gray-50 rounded-lg space-y-2">
                <input
                  ...
                  className="w-full px-3 py-1.5 rounded-lg border border-gray-300 bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300"
                />
          ...
          {scope !== 'project' && scope !== 'dashboard' && (
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 rounded-lg border border-gray-300 text-sm bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-300"
              >
