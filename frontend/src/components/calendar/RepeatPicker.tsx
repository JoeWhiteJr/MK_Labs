        ...
        <div className="p-4 rounded-xl bg-gray-50 space-y-4">
          <div className="flex items-center gap-3">
            ...
            <input
              ...
              className="w-16 text-center py-1 px-2 rounded-lg border border-gray-300 bg-white text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-300"
            />
