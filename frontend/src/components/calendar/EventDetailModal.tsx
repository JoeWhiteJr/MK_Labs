    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50" onClick={onClose}>
      ...
      >
        ...
        <div className="px-5 pt-5 pb-4 border-b border-gray-200">
          ...
          {/* Project badge */}
          {event.project_title && (
            <div className="mt-2 ml-4 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-medium bg-indigo-50 text-indigo-600">
              <FolderOpen size={12} />
              {event.project_title}
            </div>
          )}
        ...
        <div className="p-5 space-y-4">
          ...
          {event.category_name && (
            <div className="flex items-center gap-2 ml-7">
              ...
              <span className="text-sm text-gray-600">{event.category_name}</span>
            </div>
          )}
          ...
          {event.notes && (
            <div className="flex items-start gap-3">
              <StickyNote size={16} className="text-gray-400 mt-0.5 flex-shrink-0" />
