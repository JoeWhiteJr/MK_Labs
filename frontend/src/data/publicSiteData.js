...
export const partnersData = [
  ...
  { name: 'MKL', fullName: 'Michael Kairos Labs', icon: 'GraduationCap' },
  ...
  leadership: [
    {
      ...
      role: 'Director',
      bio: 'Leading the Michael Kairos Labs with expertise in statistical methodology and psychometric research.',
      email: 'ronald.miller@uvu.edu',
      linkedin: '#',
    },
    {
  ...
  partners: [
    {
      ...
      bio: 'Industry partner supporting Michael Kairos Labs initiatives.',
    },
  ],
};
...
export const aboutPageData = {
  ...
  mission: {
    title: 'Our Mission',
    lead: 'The Michael Kairos Labs bridges the gap between academic learning and professional practice by providing students with hands-on experience in statistical analysis and data science.',
...
export const faqData = [
  ...
  {
    question: 'What does it cost to work with the Michael Kairos Labs?',
...
export const donatePageData = {
  ...
  intro: {
    ...
    lead: 'The Michael Kairos Labs bridges academic learning with real-world impact. Your contribution directly supports student researchers and community-focused projects.',
  },
  impactCards: [
    {
      icon: 'GraduationCap',
