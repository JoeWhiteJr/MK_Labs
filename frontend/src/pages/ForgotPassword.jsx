...
export default function ForgotPassword() {
  ...
  useEffect(() => {
    document.title = 'Forgot Password - MKL'
  }, [])
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
          {submitted ? (
            <div className="text-center">
              ...
              <h2 className="font-display font-semibold text-xl text-text-primary mb-2">Check your email</h2>
            ...
            <>
              <h2 className="font-display font-semibold text-xl text-text-primary mb-2">Forgot password?</h2>
              <p className="text-text-secondary text-sm mb-6">
