        ...
        <div className="flex-1">
          ...
          {activeSection === 'profile' && (
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="font-display font-semibold text-lg mb-6 text-text-primary">Profile Information</h2>
          ...
          {activeSection === 'security' && (
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="font-display font-semibold text-lg mb-6 text-text-primary">Change Password</h2>
          ...
          {activeSection === 'notifications' && (
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <h2 className="font-display font-semibold text-lg mb-2 text-text-primary">Notification Preferences</h2>
