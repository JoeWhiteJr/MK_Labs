...
export default function ResetPassword() {
  ...
  useEffect(() => {
    document.title = 'Reset Password - MKL'
  }, [])
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <div className="text-center">
          <h2 className="font-display font-semibold text-xl text-text-primary mb-2">Invalid Reset Link</h2>
        ...
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-8">
          {success ? (
            <div className="text-center">
              ...
              <h2 className="font-display font-semibold text-xl text-text-primary mb-2">Password Reset!</h2>
