...
export default function TermsOfService() {
  useEffect(() => {
    document.title = 'Terms of Service | Michael Kairos Labs';
  }, []);
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-gray max-w-none">
          <p className="text-lg text-gray-600 mb-8">
            Welcome to Michael Kairos Labs (&quot;MKL,&quot; &quot;we,&quot; &quot;us,&quot; or &quot;our&quot;). By
          ...
          <p className="text-gray-600 mb-6">
            By accessing our website at michaelkairoslabs.com or using any of our services, you
          ...
          <p className="text-gray-600 mb-6">
            MKL provides a research project management platform for lab members, a public-facing
          ...
          <p className="text-gray-600 mb-6">
            ...
            property of Michael Kairos Labs or its content suppliers and is protected by
          ...
          <p className="text-gray-600 mb-6">
            To the fullest extent permitted by applicable law, MKL and its directors, employees,
          ...
          <p className="text-gray-600 mb-6">
            You agree to indemnify, defend, and hold harmless MKL, its officers, directors,
