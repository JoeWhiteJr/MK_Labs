...
function MiniProjectCard({ project, onClick }) {
  ...
  return (
    <button
      onClick={onClick}
      className="w-full text-left p-3 rounded-lg border border-gray-200 bg-white hover:border-teal-300 hover:shadow-sm transition-all group"
    >
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex-shrink-0">
          ...
          <p className="text-sm text-text-secondary">Manage and organize your research projects.</p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-6">
            ...
            {myActiveCompleted.length > 0 ? (
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
                ...
                <h3 className="font-display font-semibold text-lg text-text-primary">No projects yet</h3>
          ...
          <div className="w-full lg:w-72 xl:w-80 shrink-0 lg:sticky lg:top-4 space-y-3">
            <div className="flex items-center justify-between">
              <h2 className="font-display font-bold text-lg text-text-primary">Browse Projects</h2>
            </div>

            <select
              value={sidebarFilter}
              onChange={(e) => setSidebarFilter(e.target.value)}
              className="w-full px-3 py-2 text-sm rounded-organic border border-gray-300 bg-white text-text-primary focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400"
            >
          ...
          {teamMembers.length > 0 && (
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-2.5 rounded-organic border border-gray-300 bg-white text-text-primary focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400"
              >
